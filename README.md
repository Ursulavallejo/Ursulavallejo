...
| ------- | -------------------------------- | ---------------------------------------------------------------------------------------------- | -------------------------------- | -------------------------------------- |
| <img src="https://via.placeholder.com/150x80.png?text=Crypto+Quest" alt="Crypto Quest" width="150" /> | **Crypto Quest**                 | A Next.js–powered game interface that teaches crypto concepts through interactive challenges. | ![Next.js](https://img.shields.io/badge/Next.js-black?logo=next.js) ![Sass](https://img.shields.io/badge/Sass-CC6699?logo=sass) ![Tailwind](https://img.shields.io/badge/TailwindCSS-38B2AC?logo=tailwind-css) | 🔗 [github.com/ursula/crypto-quest](#) |
